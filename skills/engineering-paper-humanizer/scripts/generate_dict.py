...
用法:
    python scripts/generate_dict.py > dict.md
    python scripts/generate_dict.py --format latex > dict-latex.md
"""
...
CONFIG = {
    "rules_path": str(Path(__file__).parent / "text_rules.json"),
    "title": "# 中文文本去 AI 化规则速查表（自动生成）",
    "script_name": "generate_dict.py",
    "check_script": "check_text.py",
    "header_left": "❌ AI 高频词/短语",
    "header_right": "✅ 替换为",
    "always_show_connectives": True,
}
